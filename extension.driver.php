<?php
	...
	Class extension_export_ensemble extends Extension{
		...
		public function appendPreferences($context){
			...
			if(!class_exists('ZipArchive')){
				$span->appendChild(
					new XMLElement('div', '<strong>' . __('Warning: It appears you do not have the "ZipArchive" class available. Ensure that PHP was compiled with <code>--enable-zip</code>') . '</strong>')
				);
			}
			else{
